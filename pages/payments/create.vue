      ...
      <form @submit.prevent="onSubmit()">
        ...
        <div class="py-6 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-gray-700">
          <div class="flex gap-10">
            <div>
              <label for="firstName" class="inline-block text-sm font-medium dark:text-white">
                Name
              </label>
              <div class="mt-2 space-y-3">
                <input id="firstName" type="text"
                  ...
                  placeholder="Enter your first name" v-model="formData.name" label="First Name" />
            ...
            <div>
              ...
              <div class="mt-2 space-y-3">
                <input id="amount" type="number"
                  class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                  placeholder="Enter amount of money" v-model="formData.amount" label="First Name" />
        ...
        <label for="time" class="inline-block text-sm font-medium dark:text-white">
          Time
        </label>
        <div class="mt-2 space-y-3">
          <input id="time" type="time"
            class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
            placeholder="Enter your time" v-model="formData.time" label="First Name" />
          <div v-if="errorMessage.time" class="text-sm text-red-500">
            {{ errorMessage.time }}
          </div>
        </div>

        <label for="date" class="inline-block text-sm font-medium dark:text-white">
          Date
        </label>
        ...
        <div class="mt-2 space-y-3">
          <input id="date" type="date"
            class="py-2 px-3 pr-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
            placeholder="Enter your date" v-model="formData.date" label="First Name" />
        ...
        <div class="space-y-2">
          ...
          <label for="af-submit-app-upload-images"
            ...
            <input id="slip" name="slip" @change="onSlipChange" type="file" class="sr-only" />
            <div v-if="errorMessage.time" class="text-sm text-red-500">
              {{ errorMessage.time }}
            </div>
            <svg class="w-10 h-10 mx-auto text-gray-400 dark:text-gray-600" xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            <!-- <div v-if="errorMessage.slip" class="text-sm text-red-500">
              {{ errorMessage.slip }}
            </div> -->
