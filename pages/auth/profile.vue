<template>
  <section>
    <div class="flex flex-col pt-20 px-80 gap-4">
      ...
      <TheFieldIcon id="name" title="First Name" :value="auth.user.firstName">
        <path
          d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"
        />
      </TheFieldIcon>
      <TheFieldIcon id="name" title="Last Name" :value="auth.user.lastName">
        <!-- <path
          d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"
        /> -->
      </TheFieldIcon>
      <TheFieldIcon title="Phone" placeholder="Phone Number" type="tel">
        <path
