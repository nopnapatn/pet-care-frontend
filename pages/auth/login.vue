      ...
      <div class="lg:col-span-4">
        <div class="w-full p-8 lg:p-16 sm:p-8">
          ...
          <form class="mt-8 space-y-6" @submit.prevent="onSubmit()">
            ...
            <TheField id="password" v-model="formData.password" label="Password" placeholder="********"></TheField>
            ...
            <TheButtonAuth colort="bg-primary-green-100" colorb="bg-primary-green-200">Login to your account
            </TheButtonAuth>
            <TheButtonAuth colort="bg-primary-orange-50" colorb="bg-primary-orange-100">Sign in with google
            </TheButtonAuth>

            <div class="text-sm font-medium text-primary-black">
              Not registered yet?
              <NuxtLink to="/auth/register" class="text-primary-green-200 hover:underline">
...
async function onSubmit() {
  ...
  if (response.value !== null) {
    ...
    if (user.value !== null) {
      ...
      auth.setUser(firstName, lastName, email, role, id);
