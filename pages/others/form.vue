    ...
    <div class="grid grid-cols-3 pt-8">
      ...
      <div class="flex flex-col px-10 gap-y-4">
        ...
        <div class="flex flex-col gap-y-2">
          ...
          <div class="flex gap-4">
            <input type="radio" name="dog_type" value="DOG" id="dog" v-model="selectedPet"
              class="text-secondary focus:ring-primary" />
            <label for="dog">Dog</label>
          </div>
          <div class="flex gap-4">
            <input type="radio" name="cat_type" value="CAT" id="cat" v-model="selectedPet"
              class="text-secondary focus:ring-primary" />
        ...
        <div class="flex flex-col gap-y-2">
          ...
          <div class="flex gap-4">
            <input type="radio" name="spa" value="Spa Bath Package" id="spa" v-model="selectedPackage"
              class="text-secondary focus:ring-primary" checked />
            <label for="spa">Spa Bath Package</label>
          </div>
          <div class="flex gap-4">
            <input type="radio" name="groom" value="All-Inclusive Groom Package" id="groom" v-model="selectedPackage"
              class="text-secondary focus:ring-primary" />
            <label for="groom">All-Inclusive Groom Package</label>
          </div>
          <div class="flex gap-4">
            <input type="radio" name="none" value="None" v-model="selectedPackage" id="none"
              class="text-secondary focus:ring-primary" />
      ...
      <div class="flex flex-col px-1 mr-6">
        <div class="flex flex-col gap-y-4 items-start mb-4">
          ...
          <div class="flex flex-col gap-y-2 w-full">
            ...
            <div v-else-if="selectedPackage === 'All-Inclusive Groom Package'">
              ...
              <div v-for="item in groomItems" :key="item.id">
                <!-- Render item details here using item -->
                <div class="flex gap-4">
                  <input type="radio" name="radio-3" :value="item" :id="`${item.id}`" v-model="selectedType"
                    class="text-secondary focus:ring-primary" />
                  <div class="flex justify-between w-full">
          ...
          <div v-for="item in alacarteItems" :key="item.id" class="flex justify-between w-full">
      ...
      <div class="bg-primary/20 mx-6 px-8 h-fit pb-8 rounded-lg">
        ...
        <a @click="navigateToServiceReport()" class="btn btn-primary text-white bg-secondary w-full">
          Checkout
        </a>
      </div>
    </div>
