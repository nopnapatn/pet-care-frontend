                    ...
                    <form @submit.prevent="updateProfile()">
                        <div class="mt-8 space-y-4">
                            ...
                            <div>
                                ...
                                <input v-model="editedProfile.phone_number" type="text" class="text-primary-black" />
                            </div>
                            <div>
                                <label class="text-primary-orange-100">Address: </label>
                                <input v-model="editedProfile.address" type="text" class="text-primary-black" />
                            </div>
                            <div>
...
const updateProfile = async () => {
    try {
        ...
        const updatedUserData = await useMyFetch<any>(
            `profile/${auth.email}`,
            {
                method: "POST", 
                body: formData,
