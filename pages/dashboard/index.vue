  ...
  <section>
    ...
    >
      ...
      >
        ...
        >
          <div
            class="relative overflow-hidden min-h-[8rem] bg-gray-900 text-center rounded-t-xl"
          >
            <!-- Close Button -->
          ...
          <div class="p-4 sm:p-7 overflow-y-auto">
            <div class="text-center">
              ...
              <p class="text-sm text-gray-500" id="order-id">#12345</p>
            </div>
...
//   const rows = document.querySelectorAll("tr[data-toggle='modal']");

//   rows.forEach((row) => {
//     row.addEventListener("click", function () {
//       const modal = document.querySelector("#booking-order-modal");

//       // Get data from the clicked row's data attributes
//       const bookingOrderId = row.getAttribute("data-booking-order-id");
...
//       const petsAmount = row.getAttribute("data-pets-amount");
//       const totalPrice = row.getAttribute("data-total-price");
//       const ownerInstruction = row.getAttribute("data-owner-instruction");

//       // Populate the modal with the data
//       const bookingIdElement = modal!.querySelector(".booking-id");
//       bookingIdElement!.textContent = bookingOrderId;
//       const roomNumberElement = modal!.querySelector(".room-number");
//       roomNumberElement!.textContent = roomNumber;
//       const userIdElement = modal!.querySelector(".user-id");
//       userIdElement!.textContent = userId;
//       const checkInElement = modal!.querySelector(".check-in");
//       checkInElement!.textContent = checkIn;
//       const checkOutElement = modal!.querySelector(".check-out");
//       checkOutElement!.textContent = checkOut;
//       const petsAmountElement = modal!.querySelector(".pets-amount");
//       petsAmountElement!.textContent = petsAmount;
//       const totalPriceElement = modal!.querySelector(".total-price");
//       totalPriceElement!.textContent = totalPrice;
//       const ownerInstructionElement =
//         modal!.querySelector(".owner-instruction");
//       ownerInstructionElement!.textContent = ownerInstruction;
//     });
//   });
// });
</script>
